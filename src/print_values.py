...
#Print the summary
  ...
  #otex.write ('--------------------------------------------------------------\n')
  otex.write ('\\newcommand{\smass'+star+'}[1][$M_{\odot}$]{ $ %4.7f _{- %4.7f}^{ + %4.7f} $ #1} \n'%(mstar_mean,mstar_sigma,mstar_sigma))
  otex.write ('\\newcommand{\sradius'+star+'}[1][$R_{\odot}$]{ $%4.7f _{ - %4.7f}^{ + %4.7f} $ #1}\n'%(rstar_mean,rstar_sigma,rstar_sigma))
  otex.write ('\\newcommand{\stemp'+star+'}[1][$\mathrm{K}$]{ $ %4.7f _{- %4.7f}^{ + %4.7f} $ #1 }\n'%(tstar_mean,tstar_sigma,tstar_sigma))
...
#STARTING CALCULATIONS
  ...
  #Transit durations aproximations (eq. 14, 15, 16 from Winn 2014)
    ec_factor = np.sqrt(( 1. - e_vec[o]*e_vec[o] )) / ( 1.0 + e_vec[o]*np.sin(w_vec[o] + np.pi ))
...
#    if is_print_mode : opars.write ('       %4.7f , %4.7f , %4.7f   \n'%(mode_and_99(pa_vec)))
    ...
    #otex.write ('%--------------------------------------------------------------\n')
    #otex.write ('%-------------------------Fitted-------------------------------\n')
    otex.write ('\\newcommand{\Tzero'+star+plabels[o]+'}[1][days]{$%4.7f _{ - %4.7f } ^ { + %4.7f } $#1} \n'%(find_vals_perc(T0_vec[o],s_factor)))
    otex.write ('\\newcommand{\P'+star+plabels[o]+'}[1][days]{$%4.7f _{ - %4.7f } ^ { + %4.7f  }$ #1} \n'%(find_vals_perc(P_vec[o],s_factor)))
    if ( is_ew ):
      otex.write ('\\newcommand{\esin'+star+plabels[o]+'}[1][]{$%4.7f _{ - %4.7f } ^ { + %4.7f  }$ #1 } \n'%(find_vals_perc(e_dum,s_factor)))
      otex.write ('\\newcommand{\ecos'+star+plabels[o]+'}[1][]{$%4.7f _{ - %4.7f } ^ { + %4.7f  }$ #1 } \n'%(find_vals_perc(w_dum,s_factor)))
    otex.write ('\\newcommand{\e'+star+plabels[o]+'}[1][]{$%4.7f _{ - %4.7f } ^ { + %4.7f }$ #1}      \n'%(find_vals_perc(e_vec[o],s_factor)))
    otex.write ('\\newcommand{\w'+star+plabels[o]+'}[1][deg]{$%4.7f _{ - %4.7f } ^ { + %4.7f }$ #1} \n'%(find_vals_perc(w_vec[o]*180./np.pi,s_factor)))
    otex.write ('\\newcommand{\\b'+star+plabels[o]+'}[1][]{$%4.7f _{ - %4.7f } ^ { + %4.7f }$ #1}       \n'%(find_vals_perc(b_vec[o],s_factor)))
    otex.write ('\\newcommand{\\ar'+star+plabels[o]+'}[1][]{$%4.7f _{ - %4.7f } ^ { + %4.7f }$ #1}       \n'%(find_vals_perc(ar_vec[o],s_factor)))
    otex.write ('\\newcommand{\\rr'+star+plabels[o]+'}[1][]{$%4.7f _{ - %4.7f } ^ { + %4.7f  }$ #1}       \n'%(find_vals_perc(rr_vec[o],s_factor)))
    otex.write ('\\newcommand{\k'+star+plabels[o]+'}[1][$m \, s^{-1}$]{$%4.7f _{ - %4.7f  } ^ {+ %4.7f }$ #1} \n'%(find_vals_perc(k_vec[o]*1e3,s_factor)))
    #otex.write ('%-------------------------Derived------------------------------\n')
    otex.write ('\\newcommand{\i'+star+plabels[o]+'}[1][deg]{$ %4.7f _{ - %4.7f  } ^ {+ %4.7f }$ #1} \n'%(find_vals_perc(i_vec[o]*180./np.pi,s_factor)))
    otex.write ('\\newcommand{\\a'+star+plabels[o]+'}[1][AU]{$ %4.7f _{ - %4.7f  } ^ {+ %4.7f }$ #1}   \n'%(find_vals_perc(a_vec[o],s_factor)))
    otex.write ('\\newcommand{\dens'+star+plabels[o]+'}[1][$\mathrm{g\,cm^{-3}}$]{$ %4.7f _{ - %4.7f } ^ { + %4.7f }$  #1}\n'%(find_vals_perc(ds_vec[o],s_factor)))
    otex.write ('\\newcommand{\mp'+star+plabels[o]+'}[1][$M_%s$]{$%4.7f _{ - %4.7f  } ^ {+ %4.7f }$ #1} \n'%(usymbol,m_val,m_val_r,m_val_l))
    otex.write ('\\newcommand{\\rp'+star+plabels[o]+'}[1][$R_%s$]{$%4.7f _{ - %4.7f  } ^ {+ %4.7f }$ #1}   \n'%(usymbol,r_val,r_val_r,r_val_l))
    otex.write ('\\newcommand{\denp'+star+plabels[o]+'}[1][$\mathrm{g\,cm^{-3}}$]{$%4.7f _{ - %4.7f } ^ { + %4.7f  }$ #1}\n'%(find_vals_perc(pden_vec,s_factor)))
    otex.write ('\\newcommand{\gp'+star+plabels[o]+'}[1][$\mathrm{cm\,s^{-2}}$]{$%4.7f _{ - %4.7f } ^ { + %4.7f  }$ #1}\n'%(find_vals_perc(pgra_vec,s_factor)))
    otex.write ('\\newcommand{\wp'+star+plabels[o]+'}[1][deg]{$ %4.7f _{ - %4.7f  } ^ {+ %4.7f }$ #1}  \n'%(w_p_deg,w_s_deg_l,w_s_deg_r))
    otex.write ('\\newcommand{\Tperi'+star+plabels[o]+'}[1][days]{$ %4.7f _{ - %4.7f  } ^ {+ %4.7f  }$ #1} \n'%(find_vals_perc(Tpe_vec[o],s_factor)))
    otex.write ('\\newcommand{\Tequi'+star+plabels[o]+'}[1][K]{$ %4.7f _{ - %4.7f  } ^ {+ %4.7f }$  #1}    \n'%(find_vals_perc(Teq_vec[o],s_factor)))
    otex.write ('\\newcommand{\\ttot'+star+plabels[o]+'}[1][hours]{$ %4.7f _{ - %4.7f  } ^ {+ %4.7f }$  #1}\n'%(find_vals_perc(trt_vec[o],s_factor)))
    otex.write ('\\newcommand{\\tineg'+star+plabels[o]+'}[1][hours]{$ %4.7f _{ - %4.7f } ^ { + %4.7f  }$ #1}\n'%(find_vals_perc(tri_vec[o],s_factor)))
    #otex.write ('%--------------------------------------------------------------\n')
...
otex.write ('\\newcommand{\qone'+star+'}[1][]{ $%4.7f_{ - %4.7f}^{ + %4.7f } $ #1}   \n'%(find_vals_perc(q1_vec,s_factor)))
otex.write ('\\newcommand{\qtwo'+star+'}[1][]{ $%4.7f_{ - %4.7f}^{ + %4.7f } $ #1}   \n'%(find_vals_perc(q2_vec,s_factor)))
otex.write ('\\newcommand{\uone'+star+'}[1][]{ $%4.7f_{ - %4.7f}^{ + %4.7f } $ #1}   \n'%(find_vals_perc(u1_vec,s_factor)))
otex.write ('\\newcommand{\utwo'+star+'}[1][]{ $%4.7f_{ - %4.7f}^{ + %4.7f } $ #1}   \n'%(find_vals_perc(u2_vec,s_factor)))
for o in range(0,nt):
  v_val, v_val_r, v_val_l = find_vals_perc(rv_vec[o],s_factor)
...
if ( is_jitter_rv or is_jitter_tr ):
  for o in range(nt):
    otex.write ('\\newcommand{\\rvjitter'+star+'}[1][$\mathrm{m\,s^{-1}}$]{ $ %4.7f_{ - %4.7f}^{ + %4.7f } $ #1}    \n'%(find_vals_perc(params_jitter[o]*1.e3,s_factor)))
  otex.write ('\\newcommand{\\trjitter'+star+'}[1][]{ $ %4.7f_{ - %4.7f}^{ + %4.7f } $ #1}   \n'%(find_vals_perc(params_jitter[n_jrv],s_factor)))
  #otex.write ('--------------------------------------------------------------\n')
otex.write('\n')
