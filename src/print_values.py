...
#STARTING CALCULATIONS
  ...
  #Transit durations aproximations (eq. 14, 15, 16 from Winn 2014)
    ...
    #Fitted parameters
    opars.write ('--------------------------------------------------------------\n')
    opars.write ('Output format\n')
    opars.write ('par  = median -  16% + 84%   units %\n')
    opars.write ('        mode  , 0.5% , 99.%  units %\n')
    opars.write ('--------------------------------------------------------------\n')
    ...
    if ( is_ew ):
      ...
      opars.write ('       %4.7f , %4.7f , %4.7f  deg  \n'%(mode_and_99(w_vec[o]*180./np.pi)))
    ...
    opars.write ('       %4.7f , %4.7f , %4.7f  m/s  \n'%(mode_and_99(k_vec[o]*1e3)))
    opars.write ('-------------------------Derived------------------------------\n')
    if ( is_ew ):
      opars.write ('e    = %4.7f - %4.7f + %4.7f       \n'%(find_vals_perc(e_vec[o],s_factor)))
      opars.write ('       %4.7f , %4.7f , %4.7f       \n'%(mode_and_99(e_vec[o])))
    ...
    opars.write ('       %4.7f , %4.7f , %4.7f  hours\n'%(mode_and_99(trt_vec[o])))
